...
import storyImag from '../assets/1.jpg';
const Home = () => {
  return (
    <div className="home">
      {/* Hero Section */}
      ...
      <section className="featured-section py-5">
        <Container>
          ...
          >
            ...
            <Row>
              {[
                { name: 'Chocolate Dream', desc: 'Rich chocolate layers with ganache', price: '$42.99', image: 'https://images.unsplash.com/photo-1566121933407-3c7ccdd26763?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80' },
                { name: 'Berry Bliss', desc: 'Fresh seasonal berries with cream', price: '$45.99', image: 'https://images.unsplash.com/photo-1607478900766-efe13248b125?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80' },
                { name: 'Wedding Special', desc: 'Elegant multi-tier masterpiece', price: '$249.99', image: 'https://images.unsplash.com/photo-1517427294546-5aa121f68e8a?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80' },
              ].map((cake, index) => (
                  ...
                  >
                    <Card className="h-100 border-0 shadow">
                      <div className="position-relative">
                        <CardImg top width="100%" src={cake.image} alt={cake.name} className="img-fluid"                         style={{ height: '200px', objectFit: 'cover' }}/>
          ...
          <Row className="align-items-center g-5">
            ...
            <Col lg={6}>
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <img src={storyImag} alt="Our Bakery" className="img-fluid rounded-3 shadow" />
              </motion.div>
            </Col>
          </Row>
        </Container>
                  ...
                  >
                    <Card className="border-0 overflow-hidden">
                      <div className="position-relative instagram-item">
                        <CardImg src={`https://images.unsplash.com/photo-1533134242443-d4fd215305ad?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80`} alt="Instagram post" className="img-fluid" />
